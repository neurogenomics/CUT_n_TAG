...
output: 
  rmarkdown::html_document: 
    ...
    self_contained: true  
---
```{r setup, include=T, message=F, root.dir="/rds/general/project/neurogenomics-lab/live/GitRepos/CUT_n_TAG"}
...
* **WARNING!**: If you're querying many regions, this can take a long time.   

```{r Query CUT&TAG bigwig, eval=F} 
